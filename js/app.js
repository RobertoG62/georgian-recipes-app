    ...
    function updateStaticText() {
        ...
        if (heroTitle) {
            heroTitle.innerHTML = i18n.getLanguage() === 'he' ?
                'המטבח <span class="text-ge-primary-light">הגאורגי</span>' :
                '<span class="text-ge-primary-light">Georgian</span> Kitchen';
        }
        ...
        if (footerText) {
            footerText.innerHTML = i18n.t('footer.tagline') + ' <span class="text-ge-primary-light mx-1"><i class="fas fa-heart"></i></span>';
        }
